...
#    Updated: 2022/06/09 22:34:30 by myukang          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
TOKEN_SRCS = $(addprefix ./srcs/token_srcs/, parser.c tokenizer.c lexer.c token_buf_build.c  lexer_token_init.c lexer_decide_w_type.c lexer_word_converter.c)
