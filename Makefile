...
#    Updated: 2022/06/28 15:19:31 by myukang          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
EXEC_SRCS = $(addprefix ./srcs/execute_srcs/, execute.c print_cmddata.c set_heredoc.c set_redirection.c set_heredoc_tools.c check_execve_error.c execute_sub.c)
