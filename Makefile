...
#    Updated: 2022/06/13 10:23:47 by myukang          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSER_SRCS = $(addprefix ./srcs/parsing_srcs_m/, parser.c get_word_lst.c)
...
OBJ_FILES = $(MAIN_OBJS) $(BUILTIN_OBJS) $(TOOLS_OBJS) $(TOKEN_OBJS) $(PARSER_OBJS)
